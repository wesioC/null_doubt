...
<h4 class="text-center mt-5">Monitoria</h4>
...
$cod_monitoria = $_GET['fk_agendamento'];
$agendamento = $dao->getMonitoriaObj($cod_monitoria);
...
$daoAgendamento = new DaoMonitoria();
$cod_monitoria = $_GET['fk_agendamento'];

$agendados = $dao->discentesAgendados($cod_monitoria);
echo '
