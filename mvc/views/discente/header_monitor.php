            ...
            <ul class="navbar-nav navbar-top">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownExample">
                        <a class="dropdown-item" href='index.php?p=discente'>Agendar Atendimento</a>
                        <!--
...
-->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownExample">
                         <a class="dropdown-item" href="index.php?p=discente&dis=minha-monitoria">Minha Monitoria</a> 
                        <a class="dropdown-item" href='index.php?p=discente'>Agendar Monitoria</a>
                        <!--
